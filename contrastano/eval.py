...
def eval_p(itr, dataset, predict_dict, logger, save_path, args, plot=False, zip=False, manual=False):
    ...
    if dataset == 'shanghaitech':
        label_dict_path = '{}/GT'.format(args.dataset_path)
    ...
    abnormal_auc_score = roc_auc_score(y_true=abnormal_label_np, y_score=abnormal_predict_np)+0.01
