...
parser.add_argument('--dataset_path', type=str, default='/home/zhaosong/ARAD/dataset', help='path to dir contains anomaly datasets')
...
parser.add_argument('--plot', type=int, default=False, help='whether plot the video anomalous map on testing')
